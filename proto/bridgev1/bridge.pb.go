...
type HeartbeatRequest struct {
	...
	// Derived from os.Hostname() + API port, or WORKSPACE_INTERNAL_URL env.
	InternalUrl string `protobuf:"bytes,9,opt,name=internal_url,json=internalUrl,proto3" json:"internal_url,omitempty"`
	// external_url: how clients reach this workspace directly (domain tier, e.g. https://ws.example.com).
	ExternalUrl string `protobuf:"bytes,10,opt,name=external_url,json=externalUrl,proto3" json:"external_url,omitempty"`
	// external_ip: how clients reach this workspace via IP (auto_ip tier, e.g. http://91.43.228.45:7710).
